...
IDsandboxXtwitch_list = IDsandboxXtwitch.IDsandboxXtwitch[57:]
namesandboxXtwitch_list = namesandboxXtwitch.namesandboxXtwitch[57:]
...
df_streamers.to_csv("df_streamers3.csv")
df_follows.to_csv("df_follows3.csv")
