...
IDsandboxXtwitch_list = IDsandboxXtwitch.IDsandboxXtwitch[26:57]
namesandboxXtwitch_list = namesandboxXtwitch.namesandboxXtwitch[26:57]
...
df_streamers.to_csv("df_streamers2.csv")
df_follows.to_csv("df_follows2.csv")
